...
"C:\Program Files (x86)\Poedit\bin\msgfmt.exe" c:\wxWidgets-3.0.0\locale\nl.po -o syncped\nl_NL\nl.mo
"C:\Program Files (x86)\Poedit\bin\msgfmt.exe" c:\wxWidgets-3.0.0\locale\fr.po -o syncped\fr_FR\fr.mo
