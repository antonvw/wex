...
// Purpose:   Declaration of JSON-RPC 2.0 protocol handler for diagnostics
// notifications Author:    Anton van Wezenbeek Copyright: (c) 2026 Anton van
// Wezenbeek
////////////////////////////////////////////////////////////////////////////////
...
bool json_rpc::handle_publish_diagnostics(const json_rpc_message& msg)
{
  ...
  for (const auto& diag_json : diags_array)
  {
    ...
    diag.severity =
      static_cast<wex::lsp::severity_t>(diag_json["severity"].as_int());
  ...
  queue_event(m_event_handler, uri, ID_LSP_DIAGNOSTICS, get(uri));
