...
// last used style used by SCE_SH
#define SCE_SH_LAST SCE_SH_HERE_Q

#define RFW_CMD_BODY SCE_SH_LAST + 1
#define RFW_CMD_START SCE_SH_LAST + 2
#define RFW_CMD_WORD SCE_SH_LAST + 3
#define RFW_CMD_TEST SCE_SH_LAST + 4
#define RFW_CMD_ARITH SCE_SH_LAST + 5
#define RFW_CMD_DELIM SCE_SH_LAST + 6
#define RFW_CMD_SKW_PARTIAL SCE_SH_LAST + 7
#define RFW_CMD_TESTCASE SCE_SH_LAST + 8
