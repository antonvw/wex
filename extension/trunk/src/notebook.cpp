...
* RCS-ID:        $Id: notebook.cpp 16 2008-11-08 13:48:03Z anton $
*
...
{
  for (
    map<wxString,wxWindow*>::const_iterator it = m_MapPages.begin();
    it != m_MapPages.end();
    ++it)
  {
...
{
  map<wxString,wxWindow*>::const_iterator it = m_MapPages.find(key);
