...
TEST_CASE("wex::listview_stream")
{
  ...
  wex::listview_stream textFile(get_testpath("test.h"), tool);
  ...
  wex::listview_stream textFile2(get_testpath("test.h"), tool);
  ...
  wex::listview_stream textFile3(get_testpath("test.h"), tool3);
