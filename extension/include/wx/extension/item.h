...
namespace wex
{
  ...
  public:
    ...
    item(
      ...
      /// callback to apply
      UserApply apply = nullptr)
      : item(ITEM_SPINCTRLDOUBLE, label, value, LABEL_LEFT, 1, min, max, inc)
        {m_Apply = apply;
         m_Data = data;};
    ...
    item(
      ...
      /// callback to apply
      UserApply apply = nullptr)
      : item(ITEM_CHECKLISTBOX_BOOL, "checklistbox_bool", choices, LABEL_NONE, 1, 0, 1, 1) 
        {m_Apply = apply;
         m_Data = data;};
    ...
    item(
      ...
      /// - ITEM_NOTEBOOK_TREE
#ifdef __WXMSW__
      itemtype type = ITEM_NOTEBOOK_LIST,
#else
      itemtype type = ITEM_NOTEBOOK,
#endif
      /// number of rows
      int rows = 0,
      /// number of cols
      ...
      const control_data& data = control_data(),
      /// type of label
      labeltype label_type = LABEL_NONE,
    ...
    item(
      ...
      /// callback to apply
      UserApply apply = nullptr)
      : item(use_radiobox ? ITEM_RADIOBOX: ITEM_CHECKLISTBOX_BIT, label, choices,
    ...
    item(
      ...
      /// callback to apply
      UserApply apply = nullptr)
      : item(ITEM_USER, label, std::string(), label_type, 1, 0, 1, 1, window, create, config) {
          m_Apply = apply;};
    ...
    item(
      ...
      /// callback to apply
      UserApply apply = nullptr)
      : item(ITEM_LISTVIEW, label, value, label_type) {
          m_Apply = apply;
          m_ListViewData = data;};
  ...
  public:
    ...
    typedef std::tuple<std::string, itemtype, std::any> Defaults;
