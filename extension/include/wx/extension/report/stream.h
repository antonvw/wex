...
namespace wex
{
  ...
  private:
    ...
    commenttype CheckCommentSyntax(
    ...
    commenttype CheckForComment(const std::string& text);
    ...
    syntaxtype m_LastSyntaxType = SYNTAX_NONE;
    syntaxtype m_SyntaxType = SYNTAX_NONE;
  };
};
